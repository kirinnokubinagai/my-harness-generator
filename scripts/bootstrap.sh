...
# 8) GitHub Issue 駆動 vs ローカル task 駆動
echo
echo "タスク管理の方式:"
echo "  y = GitHub Issue で管理（gh issue create で親/子 issue を起票、4 レーンに割当）"
echo "  n = ローカル管理（dev/docs/task/<id>.md にファイルとして保存、git で履歴管理）"
